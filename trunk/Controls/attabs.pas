...
type
  ...
  private
    ...
    function GetTabVisible(aIndex :Integer) :Boolean;
    ...
    function IsPaintNeeded(AElemType: TATTabElemType;
                           AIndex: Integer; ACanvas: TCanvas; const ARect: TRect): boolean;
    procedure SetTabVisible(aIndex :Integer; aValue :Boolean);
  ...
  public
    ...
    procedure AddTab( AIndex: Integer; const ACaption: atString;
                      AObject: TObject = nil; AModified: boolean = false;
  ...
  published
    property TabVisible[aIndex:Integer]:Boolean read GetTabVisible write SetTabVisible;
...
procedure TATTabs.SetTabVisible(aIndex :Integer; aValue :Boolean);
begin
  GetTabData(aIndex).TabVisible := aValue;
  Invalidate;
end;
...
function TATTabs.GetTabVisible(aIndex :Integer) :Boolean;
begin
  Result := GetTabData(aIndex).TabVisible;
end;
