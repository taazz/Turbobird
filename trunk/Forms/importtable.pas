...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, Grids, MDOQuery, SynEdit, SynHighlighterSQL, sqldb,
  turbocommon, fileimport, uTBTypes;
...
type
  ...
  private
    FDestinationQuery: TMDOQuery; //TSQLQuery;
...
begin
  ...
  begin
    ...
    {$WARNING 'Build orbiting querys requires implementation'}
    //BuildOrbitQuerys(FDestinationQuery);
  end;
end;
